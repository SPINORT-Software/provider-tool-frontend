                ...
                <SubCard title="General Settings">
                    <form className={classes.root} noValidate autoComplete="off">
                        <Grid container spacing={gridSpacing}>
                            ...
                            <Grid item xs={12} md={6}>
                                <TextField id="outlined-basic6" fullWidth label="Account Email"
                ...
                <SubCard title="Advance Settings">
                    <Grid container direction="column" spacing={3}>
                        <Grid item xs={12}>
                            ...
                            <FormControlLabel
                                control={
                                    <Switch checked={state1.checkedB} onChange={handleSwitchChange1} name="checkedB"
                                            color="primary"/>
                                }
                        ...
                        <Grid item xs={12}>
                            ...
                            <FormControlLabel
                                control={
                                    <Switch checked={state2.checkedB} onChange={handleSwitchChange2} name="checkedB"
                                            color="primary"/>
                                }
                        ...
                        <Grid item xs={12}>
                            ...
                            <FormControlLabel
                                control={
                                    <Switch checked={state3.checkedB} onChange={handleSwitchChange3} name="checkedB"
                                            color="primary"/>
                                }
