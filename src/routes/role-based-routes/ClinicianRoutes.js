...
const ClientInterventionAdd = Loadable(lazy(() => import('views/roles/clinician/client-interventions/add')));

// =================== Detail Components ====================
const DailyWorkloadDetail = Loadable(lazy(() => import('views/roles/clinician/daily-workload/detail')));
const ClientAssessmentDetail = Loadable(lazy(() => import('views/roles/clinician/client-assessment/detail')));


// =================== List Components ====================
const DailyWorkloadList = Loadable(lazy(() => import('views/roles/clinician/daily-workload/list')));
const ClientAssessmentList = Loadable(lazy(() => import('views/roles/clinician/client-assessment/list')));
const ClientInterventionList = Loadable(lazy(() => import('views/roles/clinician/client-interventions/list')));
